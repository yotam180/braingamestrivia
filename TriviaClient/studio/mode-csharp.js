define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(e, t, n) {
...
}), define("ace/mode/csharp_completions", ["require", "exports", "module"], function(e, t, n) {
    "use strict";
    ...
    }).call(o.prototype), t.CSharpCompletions = o
...
}), define("ace/mode/csharp", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/csharp_highlight_rules", "ace/mode/csharp_completions", "ace/mode/matching_brace_outdent", "ace/mode/behaviour/cstyle", "ace/mode/folding/csharp"], function(e, t, n) {
    "use strict";
    var r = e("../lib/oop"),
        i = e("./text").Mode,
		...
		l = e("./csharp_completions").CSharpCompletions,
        a = e("./folding/csharp").FoldMode,
        f = function() {
            this.HighlightRules = s, this.$outdent = new o, this.$behaviour = new u, this.$completer = new l, this.foldingRules = new a
        };
    r.inherits(f, i),
        function() {
